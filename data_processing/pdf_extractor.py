...
class PDFExtractor:
    ...
    def extract_text_from_pdf(
        ...
        """
        Extract text from PDF with fixed page number offset.
        NFPA page numbers are PDF page numbers minus 3.
        ...
        Returns:
            Dict mapping NFPA page numbers to text
        """
        try:
            ...
            for page_num in range(start_idx, end_idx):
                ...
                if text.strip():
                    # Simple offset calculation: NFPA page = PDF page - 3
                    nfpa_page_num = pdf_page_num - 3
